...
const EditClip = ({
  ...
  useEffect(() => {
    ...
    if (clipAudioPath) {
      setAdAudio(new Audio(buildPlayableAudioUrl(clipAudioPath)))
    }
  }, [
  ...
  useEffect(() => {
    ...
    if (clipAudioPath && !isRecorded) {
      const newAudio = new Audio(buildPlayableAudioUrl(clipAudioPath))
      setAdAudio(newAudio)
    }
  }, [buildPlayableAudioUrl, clipAudioPath, isRecorded])
